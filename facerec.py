def Face_Recognition_System():
    ...
    def ClearCSV():
        import csv
        file = open("C:\\Users\\Gianne Bacay\\Desktop\\PROJECT-H.A.R.A.Y.A\\attendance.csv", "r")
        csvr = csv.reader(file)
        namelist = []
        Header = f'Name, Time'
        Header = Header.split(',')
        namelist.insert(0, Header)
        file = open("C:\\Users\\Gianne Bacay\\Desktop\\PROJECT-H.A.R.A.Y.A\\attendance.csv", "w", newline = '')
