...
Header = "H.A.R.A.Y.A (Human-like Autonomous Reasoning and Yielding Assistant)\n"
print(Header)
...
haraya_engine.setProperty('voice', voices[1].id)
...
def Play_Prompt_Sound():
    ...
    mp3_path = U"C:\\Users\\Gianne Bacay\\Desktop\\PROJECT-H.A.R.A.Y.A\\button1.mp3"
    playsound(mp3_path)
    
def Play_Listening_Sound():
    from playsound import playsound
    mp3_path = u"C:\\Users\\Gianne Bacay\\Desktop\\PROJECT-H.A.R.A.Y.A\\Listening.mp3"
    playsound(mp3_path)
...
def Locate_MyFullName():
    with open("C:\\Users\\Gianne Bacay\\Desktop\\PROJECT-H.A.R.A.Y.A\\attendance.csv", "r+") as attendance:
...
def run_haraya():
    ...
    #Run Command: python haraya.py
    elif "in google" in command or "in google search" in command or "google" in command:
        try:
    ...
    #Run Command: python haraya.py
        ...
        response = "as you wish! Increasing volume..."
        print(response)
        speak(response)
        ...
        response = "as you wish! Decreasing volume..."
        print(response)
        speak(response)
    ...
    #Run Command: python haraya.py
        ...
        My name is Haraya, it is an acronym for Human-like Autonomous Reasoning and Yielding Assistant.
